...
{
	SVID_FDC<int> align_error; 
	IDList<int> LoadList; 

	LoadList.LoadIDList(&align_error, "D:\\SVID\\test.txt"); 

	int a(0);


	a = align_error.getIndex(1); 
